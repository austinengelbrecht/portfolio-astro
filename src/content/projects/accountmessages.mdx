...
dataLink="/api/projectImages/accountMessages"

import PhotoGallery from "../../components/projects/PhotoGallery.vue";

<PhotoGallery client:load data={"/api/projectImages/accountMessages"} />
