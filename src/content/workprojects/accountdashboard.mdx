...
description: Building a new account dashboard and account-wide navigation. Being the key UX developer translating from design to technology, this was a unique opportunity to create a entire new page from nothing.
previewImg:
  src: https://npjmxgrfqyrxnbnmltws.supabase.co/storage/v1/object/public/images/projects/account-dashboard/account-dashboard-preview.png?t=2023-10-19T03%3A41%3A20.455Z
  alt: Screenshot of the redesigned account dashboard page
tech: ["Elm", "SASS", ".NET"]
date: 2023-09-25
---
...
<Image
  src="https://npjmxgrfqyrxnbnmltws.supabase.co/storage/v1/object/public/images/projects/account-dashboard/account-dashboard-preview.png?t=2023-10-19T03%3A41%3A20.455Z"
  alt="Final Account Dashboard Page Implementation"
  width="600"
  height="600"
  aria-hidden="true"
  class="main-img"
...
<Image
  src="https://npjmxgrfqyrxnbnmltws.supabase.co/storage/v1/object/public/images/projects/account-dashboard/account-dashboard-complete.png?t=2023-10-19T03%3A42%3A12.223Z"
  alt="Final Account Dashboard Page Implementation"
  width="600"
  height="713"
  aria-hidden="true"
...
In situations where the user has no current information to display, each card provides encouragement to finish adding information to their account or encouragement to begin shopping. The absence of data should not be a dead end for user, but rather an opportunity for engagement towards meaningful actions. This gives each card a call-to-action to either complete the account creation process to speed up their next checkout, or to begin the shopping funnel.

<Image
  src="https://npjmxgrfqyrxnbnmltws.supabase.co/storage/v1/object/public/images/projects/account-dashboard/account-dashboard-encouragement.png?t=2023-10-19T03%3A44%3A10.825Z"
  alt="Final Account Dashboard Page Implementation of Card Encouragement"
  width="600"
  height="600"
  aria-hidden="true"
  class="main-img"
